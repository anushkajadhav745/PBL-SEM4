    ...
    <nav className="bg-gray-900 p-4 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
            ...
            >
              ...
              {role === "customer" && (
                <>
                  ...
                  <Link className="block px-4 py-2 text-gray-800 hover:bg-gray-200" to="/customer/cart">
                    View Cart
                  </Link>
                  <Link className="block px-4 py-2 text-gray-800 hover:bg-gray-200" to="/customer/orders">
                    My Orders
                  </Link>
                </>
              )}
        ...
        <ul className="hidden md:flex md:space-x-6 text-white text-lg">
          ...
          {role === "customer" && (
            <>
              {/* <li><Link className="hover:text-gray-400" to="/customer/menu">Dashboard</Link></li> */}
              <li><Link className="hover:text-gray-400" to="/customer/menu">Menu</Link></li>
              <li><Link className="hover:text-gray-400" to="/customer/cart">View Cart</Link></li>
              <li><Link className="hover:text-gray-400" to="/customer/orders">My Orders</Link></li>
            </>
          )}
