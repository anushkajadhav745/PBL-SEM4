...
//         const { name, email, password, phone, role, studentId, department, year, employeeId, designation, hostelResident, profilePic } = req.body;
...
//         const token = jwt.sign({ id: newCustomer._id, role: newCustomer.role }, process.env.JWT_SECRET, { expiresIn: "7d" });
