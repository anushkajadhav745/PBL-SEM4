...
const Card = ({ item, quantity, onQuantityChange, onAddToCart }) => {
    return (
        <div className="border p-4 rounded-xl shadow-lg flex flex-col items-center text-center w-60 h-80 
                        bg-white transition-transform transform hover:scale-105 hover:bg-gray-100 border-black">
            {/* Item Image */}
            <img 
                src={item.imageUrl} 
                alt={item.name} 
